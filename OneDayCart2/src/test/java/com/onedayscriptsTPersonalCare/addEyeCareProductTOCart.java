...
public class addEyeCareProductTOCart extends Base{
	@Test
	public void productCartTest() {
       ...
       pc.getmaybellineEyeAddcart().click();
       Reporter.log("    MAYBELLINE COLOSSAL KAJAL 001 was added to your shopping cart.",true);
